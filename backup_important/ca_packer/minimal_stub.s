...
main_code_start:
    ...
    # Calculate the offset of parameter_area from the start of the stub section
    lea _start(%rip), %r11   # r11 = runtime address of _start
    sub %r11, %r8            # r8 = offset of parameter_area from _start
    add %r8, %r9             # r9 = RVA of parameter_area
    mov %r11, %r10           # r10 = runtime address of _start
